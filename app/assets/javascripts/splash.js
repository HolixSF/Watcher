$(document).on('ready', function(event){
	...
	sp.reveal('#watch_id', { duration: 1000, delay: 100 });
	sp.reveal('.t-left', { distance: '200px', origin: 'left', duration: 1000, delay: 100 });
	sp.reveal('.t-right', { distance: '200px', origin: 'right', duration: 1000, delay: 100 });
});